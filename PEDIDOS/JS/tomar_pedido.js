...
function personalizar_producto_ingredientes_y_adicionales(str_producto)
{
    ...
    rsv_solicitar('producto_ingredientes_y_adicionales',{producto: str_producto}, function(datos){
        var buffer = '';
        buffer = '<table class="contenedor_adicionales ancha delgada estandar ">';
    ...
    if (str_producto == 308) {
        ...
        {
            if (datos.aux.adicionables[x].dias == 1 || datos.aux.adicionables[x].dias == 10  && fecha == 1) {
                buffer += '<tr style="background:skyblue;" rel="'+datos.aux.adicionables[x].afinidad+'">';
                buffer += '<td style="text-align:center;"><input title="Agregar ( x1 )" type="checkbox" class="agregar_adicionable ppia_adicional" grupo="G_'+datos.aux.adicionables[x].dias+'" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
    ...
    else if (str_producto == 309) {
        for (x in datos.aux.adicionables)
        {
            if (datos.aux.adicionables[x].dias == 2 || datos.aux.adicionables[x].dias == 10  && fecha == 2) {
                buffer += '<tr style="background:skyblue;" rel="'+datos.aux.adicionables[x].afinidad+'">';
                buffer += '<td style="text-align:center;"><input title="Agregar ( x1 )" type="checkbox" class="agregar_adicionable ppia_adicional" grupo="G_'+datos.aux.adicionables[x].dias+'" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;"><input title="Agregar doble ( x2 )" type="checkbox" grupo="G_'+datos.aux.adicionables[x].dias+'" class="agregar_doble_adicionable ppia_adicional" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;">$' + datos.aux.adicionables[x].precio + '</td>';
    ...
    else if (str_producto == 310) {
        for (x in datos.aux.adicionables)
        {
            if (datos.aux.adicionables[x].dias == 3 || datos.aux.adicionables[x].dias == 10  && fecha == 3) {
                buffer += '<tr style="background:skyblue;" rel="'+datos.aux.adicionables[x].afinidad+'">';
                buffer += '<td style="text-align:center;"><input title="Agregar ( x1 )" type="checkbox" class="agregar_adicionable ppia_adicional" grupo="G_'+datos.aux.adicionables[x].dias+'" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;"><input title="Agregar doble ( x2 )" type="checkbox" grupo="G_'+datos.aux.adicionables[x].dias+'" class="agregar_doble_adicionable ppia_adicional" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;">$' + datos.aux.adicionables[x].precio + '</td>';
    ...
    else if (str_producto == 311) {
        for (x in datos.aux.adicionables)
        {
            if (datos.aux.adicionables[x].dias == 4 || datos.aux.adicionables[x].dias == 10  && fecha == 4) {
                buffer += '<tr style="background:skyblue;" rel="'+datos.aux.adicionables[x].afinidad+'">';
                buffer += '<td style="text-align:center;"><input title="Agregar ( x1 )" type="checkbox" class="agregar_adicionable ppia_adicional" grupo="G_'+datos.aux.adicionables[x].dias+'" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;"><input title="Agregar doble ( x2 )" type="checkbox" grupo="G_'+datos.aux.adicionables[x].dias+'" class="agregar_doble_adicionable ppia_adicional" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;">$' + datos.aux.adicionables[x].precio + '</td>';
    ...
    else if (str_producto == 312) {
        for (x in datos.aux.adicionables)
        {
            if (datos.aux.adicionables[x].dias == 5 || datos.aux.adicionables[x].dias == 10  && fecha == 5) {
                buffer += '<tr style="background:skyblue;" rel="'+datos.aux.adicionables[x].afinidad+'">';
                buffer += '<td style="text-align:center;"><input title="Agregar ( x1 )" type="checkbox" class="agregar_adicionable ppia_adicional" grupo="G_'+datos.aux.adicionables[x].dias+'" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;"><input title="Agregar doble ( x2 )" type="checkbox" grupo="G_'+datos.aux.adicionables[x].dias+'" class="agregar_doble_adicionable ppia_adicional" value="' + datos.aux.adicionables[x].ID_adicional + '" /></td>';
                buffer += '<td style="text-align:center;">$' + datos.aux.adicionables[x].precio + '</td>';
    ...
    else if (str_producto == 332) {
        for (x in datos.aux.adicionables)
        {
            if (datos.aux.adicionables[x].dias == 11 || datos.aux.adicionables[x].dias == 12 || datos.aux.adicionables[x].dias == 13 ) {
