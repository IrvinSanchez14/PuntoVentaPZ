...
var tiempo_telus = new Date().getDay();
	...
	if (_orden[x].fechahora_despachado !== '0000-00-00 00:00:00') {
        ...
        buffer += '<span class="editar_pedido">$' + precio + "</span>";
    ...
    orden.find('.precio_precalculo').html( '(((<span style="cursor: not-allowed;" title="Total sin IVA">$' + precio_sin_iva +
	'</span> + <span class="quitar_iva" style="cursor: pointer;" title="IVA\nClic para quitar IVA">$' + iva +
