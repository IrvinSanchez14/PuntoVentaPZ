...
$c = "SELECT `ID_producto`, `ID_grupo`, `nombre`, `orden`, `descripcion`, `precio`, `disponible`, `descontinuado`, `complementar`, `creacion`,`inicio`  FROM `productos` WHERE 1 $WHERE ORDER BY $ORDER";
$r = db_consultar($c);
$json = array();
